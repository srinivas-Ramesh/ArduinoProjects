 ...
 * ReadMe: 
 * 
 * This Arduino Program reads the data from MFRC522 nfc reader and sends data to specified URL with the help of SIM900 GSM module.
 * 
 * URL:   "https://smartshopi322373trial.hanatrial.ondemand.com/smartshop/app/items" Change this URL to a URL which is required and accepts a post call in string form.
 * 
 * APN:   "Airtel Internet". Change this APN to required APN which would be specific to the sim card being inserted in SIM900.
 */
